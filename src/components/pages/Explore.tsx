    ...
    <div className="min-h-screen bg-[#1A1C2D] text-white px-4 py-16">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Project Alpha Card */}
          <div className="bg-[#1F2937] p-6 rounded-xl hover:bg-[#22C55E]/10 transition-all">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 rounded-lg font-semibold transition-colors"
            >
              Stake Now
            </button>
          </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="bg-[#1F2937] p-4 rounded-xl hover:bg-[#22C55E]/10 transition-all cursor-pointer">

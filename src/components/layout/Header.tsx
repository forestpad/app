      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="flex space-x-4">
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-lg transition-colors ${isActive('/profile') ? 'bg-[#1E2128] text-white' : 'text-gray-400 hover:text-white hover:bg-[#1E2128]/50'}`}
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-lg transition-colors ${isActive('/rewards') ? 'bg-[#1E2128] text-white' : 'text-gray-400 hover:text-white hover:bg-[#1E2128]/50'}`}
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-lg transition-colors ${isActive('/ranking') ? 'bg-[#1E2128] text-white' : 'text-gray-400 hover:text-white hover:bg-[#1E2128]/50'}`}
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
